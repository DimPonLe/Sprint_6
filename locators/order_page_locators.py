...
first_station_metro = [By.XPATH, ".//li[contains(.,'Бульвар Рокоссовского')]"]
last_station_metro = [By.XPATH, ".//li[contains(.,'Лихоборы')]"]
...
first_time_rent = [By.XPATH, ".//div[normalize-space(text())='сутки']"]
last_time_rent = [By.XPATH, ".//div[normalize-space(text())='семеро суток']"]
